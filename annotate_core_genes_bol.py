...
parser.add_argument('--ka_ks', required=False, default = '/mnt/research/edgerpat_lab/AlanY/00_collab/02_core_pred/02_ka_ks/05_bol_at/03_codeml/bol_cds.at_cds.ka.ks.txt', help='input ka ks file')
...
if __name__ == "__main__":
  ...
  pav_dict = add_ka_ks(filename = args.ka_ks, pav_dict = pav_dict, arb_value = args.arb)
  ...
  header = ["Gene", "Membership", "Ka_Ks", "Ka", "Ks", "Length", "Exon_Count", "Exon_Length", 
  			"Intron_Length", "A","C","D","E","F","G","H","I","K","L","M","N","P","Q","R","S","T","V","W","Y","X",
  			"GO_Terms"]
