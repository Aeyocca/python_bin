...
parser.add_argument('--pav_file', required=False, 
  default = "/mnt/research/edgerpat_lab/AlanY/00_collab/02_core_pred/06_rice/pav_info_list.txt", 
...
parser.add_argument('--ortho_ka_ks', required=False, 
  default = "/mnt/research/edgerpat_lab/AlanY/00_collab/02_core_pred/02_ka_ks/07_osat_brachy/03_codeml/osat_cds.bdis_cds_mcscan.ka.ks.txt", 
  help = 'Ka/ks file, absolute path')
parser.add_argument('--cds_file', required=False, 
  default = "/mnt/research/edgerpat_lab/AlanY/00_collab/02_core_pred/06_rice//IRGSP-1.0_cds_2020-06-03.fasta", 
  help = 'cds file, absolute path')
parser.add_argument('--para_ka_ks', required=False, 
  default = "/mnt/research/edgerpat_lab/AlanY/00_collab/02_core_pred/02_ka_ks/07_osat_brachy/03_codeml/osat_cds.osat_cds.ka.ks.txt", 
  help = 'Ka/Ks file, self vs. self, absolute path')
parser.add_argument('--gff', required=False, 
  default = "/mnt/research/edgerpat_lab/AlanY/00_collab/02_core_pred/06_rice/IRGSP-1.0_representative/transcripts_exon.gff", 
  help = 'gff file, absolute path')
parser.add_argument('--gene_type', required=False, 
  default = "/mnt/home/yoccaala/01_VanBuren/mcscan/MCScanX/data/osat.gene_type", 
  help = 'gene_type file from MCScanX, absolute path')
parser.add_argument('--intron_fasta', required=False, 
  default = "/mnt/research/edgerpat_lab/AlanY/00_collab/02_core_pred/07_ms_edits/04_intron_test/osat_first_intron_all.fasta", 
