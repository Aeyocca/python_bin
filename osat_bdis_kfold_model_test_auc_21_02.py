#!/bin/python
#01-22-2021
#osat_bdis_kfold_model_test_auc_21_02.py
#Alan E. Yocca
...
if __name__ == "__main__":
	...
	#output
	filename = "osat_bdis_cv_auc_table.txt"
	if int(args.sub_feat):
		filename = "osat_bdis_cv_auc_sub_feat_table.txt"
	output_table(out_dict = out_dict, filename = filename)
