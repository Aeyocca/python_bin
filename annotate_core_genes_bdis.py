...
parser.add_argument('--pav_file', required=False, 
  default = "/mnt/research/edgerpat_lab/AlanY/00_collab/02_core_pred/04_brachy/bdis_pav_mat_ortho.txt", 
...
parser.add_argument('--ortho_ka_ks', required=False, 
  default = "/mnt/research/edgerpat_lab/AlanY/00_collab/02_core_pred/02_ka_ks/07_osat_brachy/03_codeml/bdis_cds.osat_cds.ka.ks.txt", 
  help = 'Ka/ks file, absolute path')
parser.add_argument('--cds_file', required=False, 
  default = "/mnt/research/edgerpat_lab/AlanY/00_collab/02_core_pred/04_brachy/ref_genome/Bdistachyon_283_v2.1.cds.fa", 
  help = 'cds file, absolute path')
parser.add_argument('--para_ka_ks', required=False, 
  default = "/mnt/research/edgerpat_lab/AlanY/00_collab/02_core_pred/02_ka_ks/07_osat_brachy/03_codeml/bdis_cds.bdis_cds.ka.ks.txt", 
  help = 'Ka/Ks file, self vs. self, absolute path')
parser.add_argument('--gff', required=False, 
  default = "/mnt/research/edgerpat_lab/AlanY/00_collab/02_core_pred/04_brachy/ref_genome/Bdistachyon_283_v2.1.gene.gff3", 
  help = 'gff file, absolute path')
parser.add_argument('--gene_type', required=False, 
  default = "/mnt/home/yoccaala/01_VanBuren/mcscan/MCScanX/data/bdis.gene_type", 
