...
if __name__ == "__main__":
    ...
    ml_df = pd.read_csv(args.input, delimiter = "\t", names = ["Gene", "Membership", "Ka_Ks", "Ka", "Ks",  "AED", "Length", "Exon_Count", "Exon_Length", "Intron_Length", "GO_terms" , "A", "C", "D", "E", "F", "G", "H", "I", "K", "L", "M", "N", "P", "Q", "R", "S", "T", "V", "W", "Y"])
    ...
    #features = ml_df[[ "Ka_Ks", "AED", "Length", "Exon_Count", "Exon_Length", "Intron_Length","GO_terms"]]
